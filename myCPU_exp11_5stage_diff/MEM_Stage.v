...
module MEM_Stage(
    ...
    assign load_data = 
        (ms_st_size == 2'b00) ?  // byte
            (ms_alu_result[1:0] == 2'b00 ? {24'b0, ms_data_sram_rdata[7:0]} :
             ms_alu_result[1:0] == 2'b01 ? {24'b0, ms_data_sram_rdata[15:8]} :
             ms_alu_result[1:0] == 2'b10 ? {24'b0, ms_data_sram_rdata[23:16]} : 
             {24'b0, ms_data_sram_rdata[31:24]}) :
        (ms_st_size == 2'b01) ?  // half word
            (ms_alu_result[1:0] == 2'b00 ? {16'b0, ms_data_sram_rdata[15:0]} :
             ms_alu_result[1:0] == 2'b10 ? {16'b0, ms_data_sram_rdata[31:16]} : 32'b0) : 
            ms_data_sram_rdata;  // word
