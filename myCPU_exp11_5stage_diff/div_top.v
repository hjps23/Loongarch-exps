module div_top (
  ...
  wire div_en_signed,div_en_unsigned;

  assign div_en_signed = div_is_signed && div_en;
  assign div_en_unsigned = !div_is_signed && div_en;
